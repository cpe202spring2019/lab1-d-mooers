...
class TestLab1(unittest.TestCase):
    ...
    def test_max_list_iter(self):
        ...
        # This tests for a list with a repeating number
        self.assertEqual(max_list_iter([3, 3, 4]), 4)
    ...
    def test_reverse_rec(self):
        ...
        self.assertEqual(reverse_rec([1]), [1])  # Checks list with only one entry
    ...
    def test_bin_search(self):
        ...
        list_val1 = []
        self.assertEqual(bin_search(5, 0, 9, list_val1), None)  # Checks for searching an empty list
        
        self.assertEqual(bin_search(8, 0, 4, [2, 5, 8, 90, 123]), 2)  # Tests with a complex list"
        ...
        self.assertEqual(bin_search(-1, 0, 99, big_list), None)  # Checks big list for value less than first indices

        self.assertEqual(bin_search(2, 0, 0, [2]), 0)  # Checks single entry list

        self.assertEqual(bin_search(3, 0, 3, [3, 4, 7, 12]), 0)  # Checks low index
        self.assertEqual(bin_search(12, 0, 3, [3, 4, 7, 12]), 3)  # Checks high index
